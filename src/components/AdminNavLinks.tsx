...
const AdminNavLinks = () => {
  return (
    <nav className="w-full lg:w-72 shrink-0 lg:h-screen px-4 py-6 lg:p-0 flex justify-between items-center  flex-row lg:flex-col lg:justify-start lg:items-start bg-white sticky bottom-0 order-1 lg:order-0 lg:top-0 left-0 space-y-3 z-10">
